...
def nfw_test(halo_cutout_dir='/Users/joe/repos/mpwl-raytrace/NFW_test_cases/lensing_output/nfw_0.3', 
    ...
    for i in range(len(zspl)):
        ...
        [sim_lens, true_profile] = read_nfw('{}/lensmaps_zs{}'.format(halo_cutout_dir, zspl[i]))
...
if(__name__ == "__main__"): 
    ...
    nfw_test(bin_data=False, rmin=0.2, showfig=True)
